...
def main(source_file, output_executable):
    # 初始化Clang索引
    ...
    if compile_cpp_program(source_file, output_executable):
        executable = measure_execution_time(output_executable)
...
if __name__ == '__main__':
    ...
    # Path to the C++ source file and the compiled executable
    source_file = '1A - Theater Square.cpp'

    output_executable = './Theater Square'
