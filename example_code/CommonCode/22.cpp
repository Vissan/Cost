...
void std_algorithm_example(std::vector<int>& numbers) {
...
void nested_switch_case(int a, int b) {
    switch (a) {
        case 1:
            switch (b) {
                case 1:
...
void ternary_complex(int a, int b, int c) {
    sum += (a > b) ? (a + c) : (b - c);
}
...
int main() {
    ...
    std_algorithm_example(int_numbers);
    ...
    set_operations();
    pair_operations();
    nested_switch_case(1, 2);
    ternary_complex(3, 5, 7);
    deque_operations();
    list_operations();
    stack_operations();
    queue_operations();
